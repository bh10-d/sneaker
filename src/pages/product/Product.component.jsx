                                    ...
                                    {/* <div className="row justify-content-center">
                                        ...
                                        <div className="col-6 col-md-4 col-lg-4">
                                            <div className="product product-7 text-center">
                                                <figure className="product-media">
                                                    <a href="product.html">
                                                        <img src="images/products/product-5.jpg" alt="Product image" className="product-image" />
                                                    </a>
                                                ...
                                                <div className="product-body">
                                                    ...
                                                    <div className="product-nav product-nav-thumbs">
                                                        <a href="#" className="active">
                                                            <img src="images/products/product-5-thumb.jpg" alt="product desc" />
                                                        </a>
                                                        <a href="#">
                                                            <img src="images/products/product-5-2-thumb.jpg" alt="product desc" />
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-6 col-md-4 col-lg-4">
                                            <div className="product product-7 text-center">
                                                <figure className="product-media">
                                                    <span className="product-label label-new">New</span>
                                                    <a href="product.html">
                                                        <img src="images/products/product-8.jpg" alt="Product image" className="product-image" />
                                                    </a>
                                                ...
                                                <div className="product-body">
                                                    ...
                                                    <div className="product-nav product-nav-thumbs">
                                                        <a href="#" className="active">
                                                            <img src="images/products/product-8-thumb.jpg" alt="product desc" />
                                                        </a>
                                                        <a href="#">
                                                            <img src="images/products/product-8-2-thumb.jpg" alt="product desc" />
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-6 col-md-4 col-lg-4">
                                            <div className="product product-7 text-center">
                                                <figure className="product-media">
                                                    <a href="product.html">
                                                        <img src="images/products/product-9.jpg" alt="Product image" className="product-image" />
                                                    </a>
                                                ...
                                                <div className="product-body">
                                                    ...
                                                    <div className="product-nav product-nav-thumbs">
                                                        <a href="#" className="active">
                                                            <img src="images/products/product-9-thumb.jpg" alt="product desc" />
                                                        </a>
                                                        <a href="#">
                                                            <img src="images/products/product-9-2-thumb.jpg" alt="product desc" />
                                                        </a>
                                                        <a href="#">
                                                            <img src="images/products/product-9-3-thumb.jpg" alt="product desc" />
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-6 col-md-4 col-lg-4">
                                            <div className="product product-7 text-center">
                                                <figure className="product-media">
                                                    <a href="product.html">
                                                        <img src="images/products/product-12.jpg" alt="Product image" className="product-image" />
                                                    </a>
