        ...
        <>
            <main className="main">
                            ...
                            <div className="intro-slide">
                                <figure className="slide-image">
                                    <picture>
                                        ...
                                        <img src="images/demos/demo-10/slider/slide-1.jpg" alt="Image Desc" />
                                    </picture>
                                </figure>

                                <div className="intro-content">
                                    <h3 className="intro-subtitle">Deals and Promotions</h3>
                                    <h1 className="intro-title text-white">Sneakers & Athletic Shoes</h1>
                            ...
                            <div className="intro-slide">
                                <figure className="slide-image">
                                    <picture>
                                        ...
                                        <img src="images/demos/demo-10/slider/slide-2.jpg" alt="Image Desc" />
                                    </picture>
                                </figure>

                                <div className="intro-content">
                                    <h3 className="intro-subtitle">Trending Now</h3>
                                    <h1 className="intro-title text-white">This Week's Most Wanted</h1>
                            ...
                            <div className="intro-slide">
                                <figure className="slide-image">
                                    <picture>
                                        ...
                                        <img src="images/demos/demo-10/slider/slide-3.jpg" alt="Image Desc" />
                                    </picture>
                                </figure>

                                <div className="intro-content">
                                    <h3 className="intro-subtitle text-white">Deals and Promotions</h3>
                                    <h1 className="intro-title text-white">Can’t-miss Clearance:</h1>
                        ...
                        <div className="row">
                            <div className="col-lg-8">
                                <div className="row">
                                    <div className="col-sm-6">
                                        <div className="banner banner-overlay">
                                            <a href="#">
                                                <img src="images/demos/demo-10/banners/banner-1.jpg" alt="Banner" />
                                            </a>

                                            <div className="banner-content banner-content-right">
                                                <h4 className="banner-subtitle"><a href="#">New Arrivals</a></h4>
                                                <h3 className="banner-title text-white"><a href="#">Sneakers & <br />Athletic Shoes</a></h3>
                                    ...
                                    <div className="col-sm-6">
                                        <div className="banner banner-overlay banner-overlay-light">
                                            <a href="#">
                                                <img src="images/demos/demo-10/banners/banner-2.jpg" alt="Banner" />
                                            </a>

                                            <div className="banner-content">
                                                <h4 className="banner-subtitle bright-black"><a href="#">Clearance</a></h4>
                                                <h3 className="banner-title"><a href="#">Sandals</a></h3>
                                                <div className="banner-text"><a href="#">up to 70% off</a></div>
                                ...
                                <div className="banner banner-large banner-overlay d-none d-sm-block">
                                    <a href="#">
                                        <img src="images/demos/demo-10/banners/banner-3.jpg" alt="Banner" />
                                    </a>

                                    <div className="banner-content">
                                        <h4 className="banner-subtitle text-white"><a href="#">On Sale</a></h4>
                                        <h3 className="banner-title text-white"><a href="#">Slip-On Loafers</a></h3>
                                        <div className="banner-text text-white"><a href="#">up to 30% off</a></div>
                            ...
                            <div className="col-lg-4 d-sm-none d-lg-block">
                                <div className="banner banner-middle banner-overlay">
                                    <a href="#">
                                        <img src="images/demos/demo-10/banners/banner-4.jpg" alt="Banner" />
                                    </a>

                                    <div className="banner-content banner-content-bottom">
                                        <h4 className="banner-subtitle text-white"><a href="#">On Sale</a></h4>
                                        <h3 className="banner-title text-white"><a href="#">Amazing <br />Lace Up Boots</a></h3>
                                        <div className="banner-text text-white"><a href="#">from $39.00</a></div>
                                        <a href="#" className="btn btn-outline-white banner-link btn-round">Discover Now</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        ...
                        <div className="col-sm-6 col-md-4">
                            <div className="banner banner-cat">
                                <a href="#">
                                    <img src="images/demos/demo-10/banners/banner-6.jpg" alt="Banner" />
                                </a>
                        ...
                        <div className="col-sm-6 col-md-4">
                            <div className="banner banner-cat">
                                <a href="#">
                                    <img src="images/demos/demo-10/banners/banner-7.jpg" alt="Banner" />
                                </a>
                                ...
                                <div className="row">
                                        ...
                                        <div className="product product-3 text-center">
                                            <figure className="product-media">
                                                ...
                                                <div className="product-countdown-container">
                                                    ...
                                                    <div className="product-countdown countdown-compact" data-until="2019, 11, 3" data-compact="true"></div>
                                                </div>
                                    ...
                                    <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                                        <div className="product product-3 text-center">
                                            <figure className="product-media">
                                                <span className="product-label label-primary">New</span>
                                                <a href="product.html">
                                                    <img src="images/demos/demo-10/products/product-6.jpg" alt="Product image" className="product-image" />
                                                </a>
                                            ...
                                            <div className="product-body">
                                                ...
                                                <h3 className="product-title"><a href="product.html">Eric Michael Sandra</a></h3>
                                                <div className="product-price">
                                                    $42.99
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                                        <div className="product product-3 text-center">
                                            <figure className="product-media">
                                                <a href="product.html">
                                                    <img src="images/demos/demo-10/products/product-7.jpg" alt="Product image" className="product-image" />
                                                </a>
                                            ...
                                            <div className="product-body">
                                                ...
                                                <h3 className="product-title"><a href="product.html">Jessica Simpson Blayke</a></h3>
                                                <div className="product-price">
                                                    $20.99
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                                        <div className="product product-3 text-center">
                                            <figure className="product-media">
                                                <a href="product.html">
                                                    <img src="images/demos/demo-10/products/product-8.jpg" alt="Product image" className="product-image" />
                                                </a>
                                            ...
                                            <div className="product-body">
                                                ...
                                                <h3 className="product-title"><a href="product.html">Native Shoes Miles Denim Print</a></h3>
                                                <div className="product-price">
                                                    $20.99
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                                        <div className="product product-3 text-center">
                                            <figure className="product-media">
                                                <a href="product.html">
                                                    <img src="images/demos/demo-10/products/product-9.jpg" alt="Product image" className="product-image" />
                                                </a>
                                            ...
                                            <div className="product-body">
                                                ...
                                                <h3 className="product-title"><a href="product.html">The North Face Raedonda Boot Sneaker</a></h3>
                                                <div className="product-price">
                                                    $97.99
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                                        <div className="product product-3 text-center">
                                            <figure className="product-media">
                                                <a href="product.html">
                                                    <img src="images/demos/demo-10/products/product-10.jpg" alt="Product image" className="product-image" />
                                                </a>
                                    ...
                                    <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                                        <div className="product product-3 text-center">
                                            <figure className="product-media">
                                                <a href="product.html">
                                                    <img src="images/demos/demo-10/products/product-11.jpg" alt="Product image" className="product-image" />
                                                </a>
                                            ...
                                            <div className="product-body">
                                                ...
                                                <h3 className="product-title"><a href="product.html">Splendid Roselyn II</a></h3>
                                                <div className="product-price">
                                                    $97.99
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                                        <div className="product product-3 text-center">
                                            <figure className="product-media">
                                                ...
                                                <a href="product.html">
                                                    <img src="images/demos/demo-10/products/product-12.jpg" alt="Product image" className="product-image" />
                                                </a>
                                            ...
                                            <div className="product-body">
                                                ...
                                                <h3 className="product-title"><a href="product.html">Marc Jacobs Somewhere Sport Sandal</a></h3>
                                                <div className="product-price">
                                    ...
                                    <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                                        <div className="product product-3 text-center">
                                            <figure className="product-media">
                                                <span className="product-label label-primary">New</span>
                                                <a href="product.html">
                                                    <img src="images/demos/demo-10/products/product-13.jpg" alt="Product image" className="product-image" />
                                                </a>
                                            ...
                                            <div className="product-body">
                                                ...
                                                <h3 className="product-title"><a href="product.html">Crocs Crocband Clog</a></h3>
                                                <div className="product-price">
                                                    $25.75
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                                        <div className="product product-3 text-center">
                                            <figure className="product-media">
                                                <a href="product.html">
                                                    <img src="images/demos/demo-10/products/product-14.jpg" alt="Product image" className="product-image" />
                                                </a>
                                            ...
                                            <div className="product-body">
                                                ...
                                                <h3 className="product-title"><a href="product.html">Vasque Sundowner GTX</a></h3>
                                                <div className="product-price">
                                                    $109.99
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                                        <div className="product product-3 text-center">
                                            ...
                                            <div className="product-footer">
                                                <div className="ratings-container">
                                                    <div className="ratings">
                                                        <div className="ratings-vl" style={{width: "0%"}}></div>
                                                    </div>
                                                    <span className="ratings-text">( 0 Reviews )</span>
                                                </div>
                ...
                <div className="mb-5">
                    ...
                    <div className="container">
                        <div className="cta cta-horizontal cta-horizontal-box bg-image mb-4 mb-lg-6" style={{backgroundImage: "url(images/demos/demo-10/bg-1.jpg)"}}>
                            <div className="row flex-column flex-lg-row align-items-lg-center">
                                ...
                                <div className="col-auto">
                                    <a href="#" className="btn btn-white-primary btn-round"><span>Add to Cart for $50.00/yr</span><i className="icon-long-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="blog-posts">
                        <div className="container">
                            ...
                            "responsive": {
                                ...
                                <article className="entry">
                                    <figure className="entry-media">
                                        <a href="single.html">
                                            <img src="images/demos/demo-10/blog/post-1.jpg" alt="image desc" />
                                        </a>
                                    </figure>
                                ...
                                <article className="entry">
                                    <figure className="entry-media">
                                        <a href="single.html">
                                            <img src="images/demos/demo-10/blog/post-2.jpg" alt="image desc" />
                                        </a>
                                    </figure>
                                ...
                                <article className="entry">
                                    <figure className="entry-media">
                                        <a href="single.html">
                                            <img src="images/demos/demo-10/blog/post-3.jpg" alt="image desc" />
                                        </a>
                                    </figure>
                                ...
                                <article className="entry">
                                    <figure className="entry-media">
                                        <a href="single.html">
                                            <img src="images/demos/demo-10/blog/post-4.jpg" alt="image desc" />
                                        </a>
                                    </figure>
                            ...
                            <div className="more-container text-center mt-1">
                                <a href="blog.html" className="btn btn-outline-lightgray btn-more btn-round"><span>View more articles</span><i className="icon-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
